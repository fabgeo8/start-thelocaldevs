  ...
  <header class="p-4 bg-gray-100 text-gray-800">
    ...
    <div class="container flex justify-between h-16 mx-auto">
      <ul class="items-stretch hidden space-x-3 lg:flex">
        <li class="flex">
          <a
            ...
            href="#"
            class="flex items-center px-4 -mb-1 border-b-2 border-transparent text-teal-600 border-teal-600"
            >Link</a
          >
        </li>
        <li class="flex">
      ...
      <div class="flex items-center md:space-x-4">
        ...
        <button
          type="button"
          class="hidden px-6 py-2 font-semibold rounded lg:block bg-teal-600 text-gray-50"
        >
          Log in
        </button>
      </div>
